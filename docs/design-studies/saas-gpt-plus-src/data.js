...
/* Workspace hierarchy used by the VS Code-style explorer. Document leaves
   point back to DOCUMENTS; reference assets stay visible without pretending
   to be translatable documents. */
        ...
        children: [
          {
            ...
            kind: "folder",
            children: [
              { id: "tree-onboarding", name: "onboarding-guide.docx", kind: "doc", doc: "doc-onboarding" },
              { id: "tree-release", name: "release-notes-4.2.docx", kind: "doc", doc: "doc-release" },
            ],
          },
          {
            id: "api",
            name: "API",
            kind: "folder",
            children: [{ id: "tree-api", name: "api-reference.md", kind: "doc", doc: "doc-api" }],
          },
        ],
      },
      {
        ...
        kind: "folder",
        children: [
          { id: "style-guide", name: "style-guide.pdf", kind: "asset", meta: "PDF · 1.8 MB" },
          { id: "brand-voice", name: "brand-voice.txt", kind: "asset", meta: "TXT · 12 KB" },
          { id: "screenshots", name: "screenshots", kind: "folder", children: [
            { id: "shot-welcome", name: "welcome-screen.png", kind: "asset", meta: "PNG · 244 KB" },
          ] },
        ],
      },
      {
        id: "memories",
        name: "03_Translation_Memory",
        kind: "folder",
        children: [
          { id: "main-tm", name: "Aster-main-2026.sdltm", kind: "asset", meta: "8,412 条 · 可写" },
          { id: "legacy-tm", name: "Aster-legacy.tmx", kind: "asset", meta: "3,190 条 · 只读" },
        ],
      },
      {
        id: "termbases",
        ...
        kind: "folder",
        children: [
          { id: "product-term", name: "Aster-product.tbx", kind: "asset", meta: "512 条 · 可写" },
          { id: "legal-term", name: "legal-readonly.tbx", kind: "asset", meta: "88 条 · 只读" },
        ],
      },
      {
        id: "deliverables",
        ...
        kind: "folder",
        children: [
          { id: "translated-doc", name: "onboarding-guide.zh-CN.docx", kind: "asset", meta: "上次导出 09:42" },
        ],
      },
    ],
  },
