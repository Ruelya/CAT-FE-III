...
description: "Captures executable contracts and coding conventions into .trellis/spec/ documents. Primary loader in Grok Autoloop: trellis-closeout (Phase 3). Orchestrator must not edit specs itself (no write tools)."
---
...
**Primary owner (Grok Autoloop):** `trellis-closeout` subagent at Phase 3. Orchestrator spawns closeout; it does not edit `.trellis/spec/` directly.
