...
export function AssetHub({
  ...
  return (
    <section className="surface asset-hub" data-testid="asset-hub">
      ...
      >
        {SECTIONS.map((s) => (
          <button
            ...
            aria-selected={state.section === s.id}
            disabled={busy}
            onClick={() => {
              assets.setSection(s.id);
              onSectionChange(s.id);
            }}
            data-testid={`assets-tab-${s.id}`}
          >
            {s.label}
          </button>
        ))}
      ...
      <div className="asset-hub__body" role="tabpanel">
        {state.section === "tm" ? (
          <div data-testid="assets-tm">
            ...
            <div className="editor-panel__row">
              ...
              <button
                ...
                disabled={
                  busy || state.tm.createPending || !state.tm.createName.trim()
                }
                          ...
                          <div className="dialog__actions">
                            {!mount ? (
                              ...
                              <button
                                ...
                                disabled={busy}
                                onClick={() =>
                                  void assets.unmountTm(lib.id, mount.revision)
                                }
                              >
                                Unmount
                              </button>
            ...
            <div className="dialog__actions" data-testid="tm-libraries-paging">
              <button
                type="button"
                className="btn btn--ghost btn--sm"
              ...
              <button
                ...
                disabled={
                  busy ||
                  state.tm.libraries.offset + state.tm.libraries.items.length >=
                    state.tm.libraries.total
                }
                onClick={() =>
                  void assets.loadTmLibraries(
            ...
            <ul className="editor-panel__list" data-testid="tm-search-results">
            ...
            {state.tm.search.status === "ready" ? (
              <>
                ...
                <div className="dialog__actions" data-testid="tm-search-paging">
                  <button
                    type="button"
                    className="btn btn--ghost btn--sm"
          ...
          <div data-testid="assets-termbase">
              ...
              <table className="data-table">
                ...
                <tbody>
                  {state.termbase.termbases.items.map((tb) => {
                    const mount = joinTermbaseMount(tb, state.termbase.mounts);
                    return (
                      <tr key={tb.id}>
                        <td>{tb.name}</td>
            ...
            {state.termbase.search.status === "ready" ? (
              <>
                ...
                <div className="dialog__actions" data-testid="tb-search-paging">
                  <button
                    type="button"
                    className="btn btn--ghost btn--sm"
              ...
              <>
                      ...
                      <li key={link.id}>
                        <label>
                          <input
                            ...
                            checked={selected}
                            disabled={busy}
                            onChange={() => assets.toggleLinkSelection(link.id)}
                          />{" "}
                          {link.status} ·{" "}
                ...
                <div className="editor-panel__row">
                  <input
                    ...
                    disabled={busy}
                    onChange={(e) => assets.setRefineProfileId(e.target.value)}
                ...
                <div className="editor-panel__row">
                  <select
                    ...
                    disabled={busy || state.alignment.session.status !== "open"}
              ...
              <>
                ...
                >
                  ...
                  <button
                    ...
                    onClick={() =>
                      void assets.runCorpusSearch(
                        state.corpus.search.offset + state.corpus.search.limit,
                      )
                    }
                  >
                    Next
          ...
          <div data-testid="assets-catalog">
            <div className="editor-panel__row">
              ...
              <input
                ...
                disabled={busy}
                onChange={(e) =>
                  assets.setCatalogFilter({ originDocumentId: e.target.value })
                }
            ...
            <div className="dialog__actions">
              ...
              <button
                ...
                disabled={
                  busy ||
                  state.catalog.page.offset + state.catalog.page.items.length >=
                    state.catalog.page.total
                }
                onClick={() =>
                  void assets.loadCatalog(
        ...
        {state.section === "curation" ? (
          <div data-testid="assets-curation">
            ...
            <ul className="editor-panel__list" data-testid="curation-findings">
              {state.curation.findings.items.map((f) => (
                <li key={f.id}>
                  <label>
                    <input
                      type="checkbox"
                      checked={state.curation.selectedFindingIds.includes(f.id)}
                      disabled={busy}
            ...
            <div className="editor-panel__row">
              ...
              <button
                ...
                onClick={() => void assets.applyFindings(curationActionReason)}
