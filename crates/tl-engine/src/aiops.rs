...
use tl_ai::{
    ...
    ProviderCompletion, ProviderRequest, SecretString, build_grounded_prompt, provider_descriptor,
};
...
const DRAFTING_SYSTEM_INSTRUCTION: &str = "You are a precise professional translator working inside a CAT tool. \
